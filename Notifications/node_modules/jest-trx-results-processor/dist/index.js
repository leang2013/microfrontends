...
var TrxReporter = /** @class */ (function () {
    function TrxReporter(_, options) {
        ...
        this.options = __assign(__assign({}, options), { defaultUserName: (_a = options === null || options === void 0 ? void 0 : options.defaultUserName) !== null && _a !== void 0 ? _a : constants_1.defaultUserName, outputFile: (_b = options === null || options === void 0 ? void 0 : options.outputFile) !== null && _b !== void 0 ? _b : constants_1.defaultOutputFile });
    }
    return TrxReporter;
}());
